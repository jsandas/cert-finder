# Coding Standards for cert-finder
...
- If the current PR is too broad, break it into smaller ones (e.g., one for API changes, one for tests).
- Never commit to or push to the main/master branch.
